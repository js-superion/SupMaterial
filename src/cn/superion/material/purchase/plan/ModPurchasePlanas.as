...
private function initToolBar():void
{
	...
	var laryEnables:Array=[toolBar.btAdd,toolBar.btAuto, toolBar.btQuery, toolBar.btExit];
...
var dict:Dictionary=new Dictionary();
	...
	if (printSign == '1')
		ReportPrinter.LoadAndPrint("report/material/purchase/purchasePlan.xml", _dataList, dict);
	if (printSign == '0')
		ReportViewer.Instance.Show("report/material/purchase/purchasePlan.xml", _dataList, dict);
