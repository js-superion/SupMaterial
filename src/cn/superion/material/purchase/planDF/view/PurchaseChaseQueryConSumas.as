...
import cn.superion.material.purchase.planDF.ModPurchasePlan
...
//					return;
//				}
//				if (e.currentTarget.id == "materialCodeFrom")
//				{
//					materialCodeFrom_queryIconClickHandler(e);
//					return;
//				}
//				if (e.currentTarget.id == "materialCodeTo")
//				{
//					materialCodeTo_queryIconClickHandler(e);
//					return;
//				}
//			}
...
protected function btQuery_clickHandler(event:Event):void
{
	...
	fparameter["operationType"]=stockType.selectedItem.operationType;
//	fparameter["beginBillNo"]=billNoFrom.text;//byzcl
...
//	fparameter["beginMaterialCode"]=materialCodeFrom.text;//byzcl
//	fparameter["endMaterialCode"]=materialCodeTo.text;
//	fparameter["salerCode"]=salerCode.text == null ? null : salerCode1;
...
//			data.parentWin.findRdsById(rev.data[0]);
			data.parentWin.gridDetail.dataProvider=rev.data;
			setToolBarPageBts(rev.data.length);
		});
	ro.findMaterialPlanDetailListByCondition(params);
	returnHandler();
}
/**
 * 设置当前按钮是否显示
...
protected function stockType_creationCompleteHandler(event:FlexEvent):void
{
	...
	stockType.dataProvider=typeArc;
}