...
private function initToolBar():void
{
	...
	var laryEnables:Array=[toolBar.btQuery,toolBar.btVerify,toolBar.btCancel, toolBar.btExit];
...
//	}
	...
	for each(var item:Object in tempAry){
		if(item.isSelected){
			...
			materialProvideMaster.currentStatus = '3';
			newAry.addItem(materialProvideMaster);
		}
	}
	if(newAry.length == 0){
...
//	_fparameter.checkAmountSign = status.selectedItem?status.selectedItem.k:"0,1";//'1,2';
	...
	var ro:RemoteObject=RemoteUtil.getRemoteObject(DESTANATION, function(rev:Object):void
	{
		...
		if(_fparameter.currentStatus == '2'){
