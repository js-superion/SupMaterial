...
private static const MENU_NO:String="0112";
...
//	_fparameter.checkAmountSign = status.selectedItem?status.selectedItem.k:"2,3";//1,4,5查找全部的，包含院领导审核过的，1：为手工申请，4，为总务审核的
	_fparameter.currentStatus = status.selectedItem?status.selectedItem.k:"2,3";//1,4,5查找全部的，包含院领导审核过的，1：为手工申请，4，为总务审核的
	param.conditions = _fparameter
	var ro:RemoteObject=RemoteUtil.getRemoteObject(DESTANATION, function(rev:Object):void
	{
		if(_fparameter.currentStatus == '2'){ //未审
...
{
	// TODO Auto-generated method stub
	if(status.selectedItem.k =='3'||status.selectedItem.k =='4'){
