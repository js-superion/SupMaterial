...
protected function doInit():void
{
	...
	//业务类型
	operationType.dataProvider=new ArrayCollection([{operationType: null, operationTypeName: '全部'}, {operationType: '101', operationTypeName: '普通采购'}, {operationType: '102', operationTypeName: '受托代销'}, {operationType: '103', operationTypeName: '直运'}]);
...
protected function btConfirm_clickHandler(event:MouseEvent):void
{
	...
	if(invoiceNo.text != null && StringUtils.Trim(invoiceNo.text) != ''){
		params['invoiceNo']=invoiceNo.text;
	}
