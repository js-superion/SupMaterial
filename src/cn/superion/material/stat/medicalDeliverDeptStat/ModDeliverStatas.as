...
import cn.superion.material.stat.medicalDeliverDeptStat.view.WinDeliverStatQuery;
...
protected function doInit():void
{
	if(parentDocument is WinModual){
		parentDocument.title="计算机出库部门汇总表";
	}
	initPanel();
	...
	ros.findDeliverStatListByDeptComputer(null);//byzcl
}
