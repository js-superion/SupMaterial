...
import cn.superion.material.stat.medicalMonthReceiveFee.view.WinDeliverStatQuery;
...
protected function doInit():void
{
	if(parentDocument is WinModual){
		parentDocument.title="医用耗材入库月报表";
	}
	initPanel();
...
private function makeExport(dataGridName:Object):void{
	...
	var excelTitle:String='医用耗材入库月报表'+_currentDate;
