...
import cn.superion.material.stat.deliverDeptStat.view.WinDeliverStatQuery;
...
protected function doInit():void
{
	...
	var ros:RemoteObject=RemoteUtil.getRemoteObject(DESTINATION, function(rev:Object):void
	{
		...
		if(rev && rev.data[0] != null){
			...
			gdDeliver.sumField=['sum','material1','material2','material3','material4'];
			
		}
		
	});
	ros.findDeliverStatListByDeptNew(null);//byzcl
}
...
private function makeExport(dataGridName:Object):void{
	...
	var excelTitle:String='按部门出库统计表'+_currentDate;
...
//	}  
	...
	if (printSign == '1')
	{
		ReportPrinter.LoadAndPrint("report/material/stat/deliverDeptStat.xml", dataList, dict);
	}
	else
	{
		ReportViewer.Instance.Show("report/material/stat/deliverDeptStat.xml", dataList, dict);
	}
}
