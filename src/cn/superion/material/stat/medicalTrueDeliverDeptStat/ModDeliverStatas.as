...
import cn.superion.material.stat.medicalTrueDeliverDeptStat.view.WinDeliverStatQuery;
...
protected function doInit():void
{
	if(parentDocument is WinModual){
		parentDocument.title="医疗出库部门汇总表";
	}
	initPanel();
...
private function makeExport(dataGridName:Object):void{
	...
	var excelTitle:String='医疗出库汇总表'+_currentDate;
