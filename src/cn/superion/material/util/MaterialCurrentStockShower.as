package cn.superion.material.util
{
	...
	public class MaterialCurrentStockShower
	{
		...
		public static function showCurrentStockDF(fstrStorageCode:String, fstrMaterialId:String, fstrBatch:String, callback:Function, x:int=-1, y:int=-1):void
		{
			if (isDictWinShow)
			{
				return
			...
			var win:WinCurrentStockAmount=WinCurrentStockAmount(PopUpManager.createPopUp(DisplayObject(FlexGlobals.topLevelApplication), WinCurrentStockAmount, true));
